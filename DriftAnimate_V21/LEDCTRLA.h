...
#define STATUS_TEST_MODE_bp           (1 << STATUS_TEST_MODE_bp)
// TBD                                (1 << STATUS_TBD_bp)
#define STATUS_COLOR_CHANGE_bp        (1 << STATUS_COLOR_CHANGE_bp)
#define STATUS_ADJUST_CHANGE_bp       (1 << STATUS_ADJUST_CHANGE_bp)
#define STATUS_MODE_CHANGE_bp         (1 << STATUS_MODE_CHANGE_bp)
#define STATUS_UI_CHANGE_bp           (1 << STATUS_UI_CHANGE_bp)
 ...
 *
 * Everything related to this device must be designed with performance formost in the mind. If we pushed the silicon any harder, we'd end up snapping
